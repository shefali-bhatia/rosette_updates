...
; change back to content-b when done (t1 and t2)
(define table1 (Table "t1" '("a" "b" "c") content-a))
(define table2 (Table "t2" '("a" "b" "c") content-a))
...
(define q5 (LEFT-OUTER-JOIN (NAMED table2) (NAMED table1) (BINOP "t1.b" = "t2.a"))) 
...
(define q7
 (FULL-OUTER-JOIN (NAMED table1) (NAMED table2) (BINOP "t1.b" = "t2.a")))
